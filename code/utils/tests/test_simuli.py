...
def test_events2neural():
    ...
    neural = stimuli.events2neural(data_location+'cond_test1.txt', 2, 16)
    ...
    #neural = stimuli.events2neural(data_location+'cond_test1.txt', 1, 30)
...
def test_events2neural_high():
    ...
    test_high_res_times, test_high_res_neural = events2neural_high(data_location+'ds005/sub003/model/model001/onsets/task001_run001/cond002.txt')
