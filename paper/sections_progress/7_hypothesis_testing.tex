...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.5]{../../correlation_s1r1c2.png}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.5]{correlation_s1r1c3.png}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.5]{t_statistics_for_condition_2.png	}
...
\begin{figure}[H]
    \centering
        \includegraphics[scale=0.5]{t_statistics_for_condition_3.png	}
